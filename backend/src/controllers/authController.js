...
//     const user   = await User.create({ name: name.trim(), email: email.toLowerCase().trim(), password, avatar, referredBy })
...
//         message: 'You received 100 bonus coins. Join a contest and start winning!',
//         type:    'wallet',
//       })
//     } catch (_) {}
...
//       console.log(`[Auth] Password reset link: ${process.env.CLIENT_URL}/reset-password/${token}`)
//     }
