export default function FairPlay() {
  const sections = [
    ...
    { title: '📢 Reporting', body: 'Report cheating via the in-app feature or email fairplay@quizarena.in. Include the contest ID, username, and nature of suspected violation. All reports are investigated manually.' },
    { title: '🏆 Our Commitment', body: 'We review all flagged cases before taking action. You may appeal any decision by contacting support@quizarena.in within 7 days.' },
  ]
  return (
