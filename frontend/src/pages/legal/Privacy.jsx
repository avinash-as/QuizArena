export default function Privacy() {
  const sections = [
    ...
    { title: 'Advertising', body: "If QuizArena displays ads, our ad partners may collect data as described in their own privacy policies, in line with Google Play's Families and advertising ID policies where applicable." },
    { title: 'Your Rights', body: 'You have the right to access, correct, or delete your personal data, including deleting your account entirely from within the app or by contacting privacy@quizarena.in.' },
    { title: 'Retention', body: 'Account and gameplay data is retained until you delete your account. We do not retain financial transaction records, since QuizArena does not process real-money transactions.' },
  ]
  return (
